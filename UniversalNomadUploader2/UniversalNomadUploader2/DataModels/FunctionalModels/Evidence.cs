...
namespace UniversalNomadUploader.DataModels.FunctionalModels
{
    public class Evidence
    {
        ...
        public Evidence(String _fileName, String _extension, DateTime _createdDate, int _serverID, String _name, MimeTypes _mimeType)
        {
            FileName = _fileName;
        ...
        public Evidence(SQLModels.SQLEvidence e)
        {
